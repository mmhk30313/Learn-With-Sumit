...
export default function Sidebar() {
    ...
    return (
        <div className="w-[100px] border-r border-t-0 border-gray-300 lg:col-span-1 md:w-full">
            <div className="bg-gray-300 h-[65px] text-center text-grey-500 p-4 border-b border-gray-300 flex md:justify-between justify-center">
                <div className="flex items-center justify-center">
                    <img
                        className="object-cover w-10 h-10 rounded-full"
                        src={gravatarUrl(email, {size: 100})}
                        alt={user?.name}
                    />
...
C139.689,120.449,136.331,117.092,132.189,117.092z"
            ...
            <div className="bg-gray-100 overflow-auto h-[calc(100vh_-_128px)]">
                <ChatItems />
            </div>
            {/* <Blank /> */}
