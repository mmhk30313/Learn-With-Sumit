...
# assignment-8---advanced-todo-application-with-rtk-query-mmhk30313

## Simple Todo Application

## Netlify Hosted URL:
### https://lws-advanced-rtk-todos.netlify.app



## Heroku Hosted URL
### https://server-mmhk-json.herokuapp.com
...
```bash
GET https://server-mmhk-json.herokuapp.com/todos
```

Retrieve one (GET):

```bash
GET https://server-mmhk-json.herokuapp.com/todos/1
```

Post a todo (POST):

```bash
POST https://server-mmhk-json.herokuapp.com/todos text="Learn Redux" completed=false color="red"
```

Update todo (PUT):

```bash
PUT https://server-mmhk-json.herokuapp.com/todos/3 name="Learn Redux with Learn with Sumit" completed=true color="green"
```

Delete todo (DELETE):

```bash
DELETE https://server-mmhk-json.herokuapp.com/todos/1
```
# Local Installation

```bash
git clone https://github.com/Learn-with-Sumit/assignment-8---advanced-todo-application-with-rtk-query-mmhk30313.git(https://github.com/mmhk30313/lws-todo-server.git)
cd assignment-8---advanced-todo-application-with-rtk-query-mmhk30313
yarn or npm install
nodemon start
```
...
### To run this project:
    * git clone https://github.com/Learn-with-Sumit/assignment-4---add-features-to-todo-application-mmhk30313.git
    * cd assignment-4---add-features-to-todo-application-mmhk30313
    * yarn or npm install
    * yarn start
