...
# assignment-4---add-features-to-todo-application-mmhk30313

## Simple Todo Application

## Netlify Hosted URL:
### https://lws-todos-app.netlify.app



## Heroku Hosted URL
### https://lws-todos-server.herokuapp.com

## Heroku Server URL:
### https://lws-todos-server.herokuapp.com/api
...
```bash
GET https://lws-todos-server.herokuapp.com/api/todos
```

Retrieve one (GET):

```bash
GET https://lws-todos-server.herokuapp.com/api/todos/1
```

Post a todo (POST):

```bash
POST https://lws-todos-server.herokuapp.com/api/todos text="Learn Redux" completed=false color="red"
```

Update todo (PUT):

```bash
PUT https://lws-todos-server.herokuapp.com/api/todos/3 name="Learn Redux with Learn with Sumit" completed=true color="green"
```

Delete todo (DELETE):

```bash
DELETE https://lws-todos-server.herokuapp.com/api/todos/1
```
# Local Installation

```bash
git clone git@github.com:learnwithsumit/lws-json-server-todos.git](https://github.com/mmhk30313/lws-todo-server.git)
cd lws-todo-server
yarn or npm install json-server
nodemon start
```
